...
class ProfileModSection extends StatefulWidget {
  final DatabaseReference dbRef;

  ProfileModSection({Key? key, required this.dbRef}) : super(key: key);

  @override
  _ProfileModSectionState createState() => _ProfileModSectionState();
}

class _ProfileModSectionState extends State<ProfileModSection> {
